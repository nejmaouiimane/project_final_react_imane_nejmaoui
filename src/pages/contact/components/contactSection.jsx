            ...
            <div className='flex py-16 px-2 justify-center gap-10 lg:flex-row flex-col'>
                ...
                <div>
                    <form className='flex flex-col w-[20vw] gap-3' action="">
                        ...
                        <input className=' border-slate-200 lg:lg:w-[30vw] w-[90vw] ' placeholder=' Name' type="text" /> 
                        <input className='border-slate-200 lg:w-[30vw] w-[90vw]'placeholder=' Email' type="text" />
                        <input className='border-slate-200 lg:w-[30vw] w-[90vw]'placeholder=' Phone' type="number" />
                        <textarea className='border-slate-200 lg:w-[30vw] w-[90vw]'placeholder=' Message' name=" " id="" cols="30" rows="10"></textarea>
